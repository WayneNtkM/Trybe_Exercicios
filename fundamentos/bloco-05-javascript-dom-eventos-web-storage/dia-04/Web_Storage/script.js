...
let anos = ['2021', '2022']
storage.setItem('anos', JSON.stringify(anos))
let ans = JSON.parse(storage.getItem('anos'))
console.log(ans)
...
storage.setItem('nome', JSON.stringify(nome))
let nm = JSON.parse(storage.getItem('nome'))
console.log(nm)
